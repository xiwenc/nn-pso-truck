// $Id: neural.h 59 2010-11-23 11:42:14Z xcheng $
/*!
 @file
 @author xcheng
 @class Neural
 @brief Strongly connected recurrent neural network with mutiple input and outputs
 @detail This RNN has the form: I -> H1 ... Hn -> O where I is an input layer and O the output. The hidden layer H's are strongly connected. Meaning all the nodes in the the layer has a connection to all other nodes. N nodes per layer are constant.
