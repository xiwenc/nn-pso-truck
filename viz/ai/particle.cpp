// $Id: particle.cpp 60 2010-11-23 16:06:53Z xcheng $
...
void Particle::update(Vec gbest, Test* test) {
    update(gbest, test, NULL);
}
void Particle::update(Vec gbest, Test* test, Settings* settings) {
...
float Particle::evaluate(Test* test, Settings* settings) {
    ...
    _fitness = oBackground.Fitness(test, settings);
    // reset test/truck
    delete test;
    test = Truck::Create();
