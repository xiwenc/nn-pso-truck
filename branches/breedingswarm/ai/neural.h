// $Id: neural.h 73 2010-12-21 13:19:07Z xcheng $
/*!
 @file
 @author xcheng
 @class Neural
 @brief Strongly connected recurrent neural network with mutiple inputs and outputs

 This RNN has the form: I -> H1 ... Hn -> O where I is an input layer and O the output. The hidden layer H's are strongly connected. Meaning all the nodes in the the layer has a connection to all other nodes. N nodes per layer are constant.
