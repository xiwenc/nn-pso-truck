...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-Linux-x86/breedingswarm

dist/Debug/GNU-Linux-x86/breedingswarm: ${OBJECTFILES}
	${MKDIR} -p dist/Debug/GNU-Linux-x86
	${LINK.cc} -lGLU -lGL -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/breedingswarm ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/ai/ga.o: ai/ga.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -g -I../Box2D/Contrib -I../Box2D/Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/ga.o ai/ga.cpp
...
${OBJECTDIR}/ai/bs.o: ai/bs.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -g -I../Box2D/Contrib -I../Box2D/Include -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/bs.o ai/bs.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-Linux-x86/breedingswarm
