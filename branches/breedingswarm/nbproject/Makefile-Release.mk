...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/breedingswarm

dist/Release/GNU-Linux-x86/breedingswarm: ${OBJECTFILES}
	${MKDIR} -p dist/Release/GNU-Linux-x86
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/breedingswarm ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
${OBJECTDIR}/ai/ga.o: ai/ga.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/ga.o ai/ga.cpp
...
${OBJECTDIR}/ai/bs.o: ai/bs.cpp 
	${MKDIR} -p ${OBJECTDIR}/ai
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ai/bs.o ai/bs.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/breedingswarm
